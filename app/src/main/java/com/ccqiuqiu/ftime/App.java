...
public class App extends Application {
    ...
    public static int mHolidayVer = 2018100701;
    ...
    private void initHoliday() {
        ...
        try {
            ...
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2017, 12, 30, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2017, 12, 31, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 1, 1, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 2, 11, 1)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 2, 15, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 2, 16, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 2, 17, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 2, 18, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 2, 19, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 2, 20, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 2, 21, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 2, 24, 1)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 4, 5, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 4, 6, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 4, 7, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 4, 8, 1)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 4, 28, 1)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 4, 29, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 4, 30, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 5, 1, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 6, 16, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 6, 17, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 6, 18, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 9, 22, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 9, 23, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 9, 24, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 9, 29, 1)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 9, 30, 1)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 10, 1, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 10, 2, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 10, 3, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 10, 4, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 10, 5, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 10, 6, 0)";
            holidayService.db.execNonQuery(sql.toString());
            sql = "INSERT INTO holiday (year, month, date, status) VALUES (2018, 10, 7, 0)";
            holidayService.db.execNonQuery(sql.toString());
