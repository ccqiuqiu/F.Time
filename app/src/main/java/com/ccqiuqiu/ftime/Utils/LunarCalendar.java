...
public class LunarCalendar {
    ...
    /**
     * @param date 2016年正月初一
     * @return string yyyy-MM-dd
     */
    public static String lunarToSolar(String date) {
        List<String> ms = Arrays.asList(chineseMonthNum);
        List<String> ds = Arrays.asList(chineseDayNum);
        int y = Integer.parseInt(date.substring(0, 4));
        int m = ms.indexOf(date.substring(5, 7));
        int d = ds.indexOf(date.substring(7, 9));
        int[] re = lunarToSolar(y, m, d, false);
        String month = re[1] + "";
        if (re[1] < 10) {
            month = "0" + re[1];
        }
    ...
    public static String solarToLunar(GregorianCalendar calendar) {
        int[] aa = solarToLunar(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH) + 1, calendar.get(Calendar.DAY_OF_MONTH));
        return aa[0] + "年" + chineseMonthNum[aa[1]] + chineseDayNum[aa[2]];
    }

    public static String solarToLunar(String s) {
        Date date = DateUtils.StringToDate(s);
        int[] aa = solarToLunar(DateUtils.getYear(date), DateUtils.getMonth(date), DateUtils.getDay(date));
        return aa[0] + "年" + chineseMonthNum[aa[1]] + chineseDayNum[aa[2]];
    }

//    public static String[] solarToLunarArr(GregorianCalendar calendar) {
//        int[] aa = solarToLunar(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH) + 1, calendar.get(Calendar.DAY_OF_MONTH));
//        String[] re = new String[3];
//        re[0] = aa[0] + "年";
//        re[1] = chineseMonthNum[aa[1]];
//        re[2] = chineseDayNum[aa[2]];
//        re[3] = aa[3] == 0?"":"闰";
//        return  re;
//    }
//
//    private static String lunarToString(int[] lunar) {
//        return lunar[0] + "年" + chineseMonthNum[lunar[1]] + chineseDayNum[lunar[2]];
//    }
    ...
    private static String[] chineseMonthNum = {
            "0", "正月", "二月", "三月", "四月", "五月", "六月",
            "七月", "八月", "九月", "十月", "冬月", "腊月"
    };
    private static String chineseDayNum[] = {
            "0", "初一", "初二", "初三", "初四", "初五", "初六", "初七", "初八", "初九", "初十",
            "十一", "十二", "十三", "十四", "十五", "十六", "十七", "十八", "十九", "二十",
            "廿一", "廿二", "廿三", "廿四", "廿五", "廿六", "廿七", "廿八", "廿九", "三十",
    };

    public static void main(String[] args) {
//        int[] aa = solarToLunar(2020, 1, 1);
//        System.out.println(aa[0] + "-" + chineseMonthNum[aa[1]] + "-" + chineseDayNum[aa[2]]);
    }
}